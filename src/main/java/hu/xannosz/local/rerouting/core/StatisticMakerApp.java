...
public class StatisticMakerApp {
    ...
    public static void run(int count, String algorithmName) {
        Date start = new Date();
        ...
        for (ErdosRenyi.Settings graphSettings : graphType.getSettings()) {
            for (Algorithm algorithm : ALGORITHMS) {
                if (algorithmName != null && !algorithmName.isEmpty() && !algorithmName.equals(algorithm.getName())) {
                    continue;
                }
        ...
        System.out.println("\nTotal Time: " + (new Date().getTime() - start.getTime()));
    }
