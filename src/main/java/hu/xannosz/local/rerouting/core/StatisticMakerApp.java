...
import static hu.xannosz.local.rerouting.core.util.Constants.FAILURE_GENERATORS;
import static hu.xannosz.local.rerouting.core.util.Constants.STATISTICS;
...
public class StatisticMakerApp {
    ...
    public static void run(int count) {
        ...
        for (ErdosRenyi.Settings graphSettings : graphType.getSettings()) {
            ...
            Algorithm algorithm = new KruskalAlgorithmPreProcess();
